...
public interface RabbitMqService {
    ...
    Call<List<Connection>> getConnections(@Path("vhost") String vhost);
    ...
    Call<List<Channel>> getChannels(@Path("vhost") String vhost);
    ...
    @GET("exchanges/{vhost}")
    Call<List<ExtendedExchange>> getExchanges(@Path("vhost") String vhost);

    @GET("exchanges/{vhost}/{exchange}")
    Call<ExtendedExchange> getExchange(@Path("vhost") String vhost, @Path("exchange") String exchange);
    ...
    Call<List<Binding>> getSourceBindings(@Path("vhost") String vhost, @Path("exchange") String exchange);

    @GET("exchanges/{vhost}/{exchange}/bindings/destination")
    Call<List<Binding>> getDestinationBindings(@Path("vhost") String vhost, @Path("exchange") String exchange);
    ...
    @GET("queues/{vhost}")
    Call<List<ExtendedQueue>> getQueues(@Path("vhost") String vhost);
    ...
    Call<List<Binding>> getQueueBindings(@Path("vhost") String vhost, @Path("queue") String queue);
    ...
    @GET("bindings/{vhost}")
    Call<List<Binding>> getBindings(@Path("vhost") String vhost);

    @GET("bindings/{vhost}/e/{exchange}/q/{queue}")
    Call<List<ExtendedBinding>> getBindingsBetweenExchangeAndQueue(@Path("vhost") String vhost, @Path("exchange") String exchange, @Path("queue") String queue);

    // TODO: Add POST /bindings/{vhost}/e/{exchange}/q/{queue}.

    @GET("bindings/{vhost}/e/{exchange}/q/{queue}/{props}")
    Call<ExtendedBinding> getBindingsBetweenExchangeAndQueue(@Path("vhost") String vhost, @Path("exchange") String exchange, @Path("queue") String queue, @Path("props") String propertiesKey);

    // TODO: Add DELETE /bindings/{vhost}/e/{exchange}/q/{queue}/props.

    @GET("bindings/{vhost}/e/{source}/e/{destination}")
    Call<List<ExtendedBinding>> getBindingsBetweenExchanges(@Path("vhost") String vhost, @Path("source") String srcExchange, @Path("destination") String dstExchange);

    // TODO: Add POST /bindings/{vhost}/e/{source}/e/{destination}.

    @GET("bindings/{vhost}/e/{source}/e/{destination}/{props}")
    Call<ExtendedBinding> getBindingsBetweenExchanges(@Path("vhost") String vhost, @Path("source") String srcExchange, @Path("destination") String dstExchange, @Path("props") String propertiesKey);
    ...
    @GET("vhosts/{name}")
    Call<ExtendedVhost> getVhost(@Path("name") String name);
