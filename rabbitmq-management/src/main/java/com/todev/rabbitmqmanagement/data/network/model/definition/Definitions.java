...
public class Definitions {
  ...
  @JsonProperty(value = "bindings") protected List<Binding> bindings = new ArrayList<>();

  @JsonProperty(value = "exchanges") protected List<Exchange> exchanges = new ArrayList<>();

  // TODO: Parameters should be corrected.

  @JsonProperty(value = "parameters") protected List<Object> parameters = new ArrayList<>();

  @JsonProperty(value = "permissions") protected List<Permission> permissions = new ArrayList<>();

  @JsonProperty(value = "policies") protected List<Policy> policies = new ArrayList<>();

  @JsonProperty(value = "queues") protected List<Queue> queues = new ArrayList<>();

  @JsonProperty(value = "rabbit_version") protected String rabbitVersion;

  @JsonProperty(value = "users") protected List<ExtendedUser> users = new ArrayList<>();

  @JsonProperty(value = "vhosts") protected List<Vhost> vhosts = new ArrayList<>();
