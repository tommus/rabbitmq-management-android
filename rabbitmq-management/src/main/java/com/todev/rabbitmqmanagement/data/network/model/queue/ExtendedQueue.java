...
public class ExtendedQueue extends Queue {
  ...
  @JsonProperty(value = "backing_queue_status") protected BackingQueueStatus backingQueueStatus;

  @JsonProperty(value = "consumer_utilisation") protected Object consumerUtilisation;

  @JsonProperty(value = "consumers") protected int consumers;

  @JsonProperty(value = "disk_reads") protected int diskReads;

  @JsonProperty(value = "disk_writes") protected int diskWrites;

  @JsonProperty(value = "exclusive") protected boolean exclusive;

  @JsonProperty(value = "exclusive_consumer_tag") protected Object exclusiveConsumerTag;

  @JsonProperty(value = "head_message_timestamp") protected Object headMessageTimestamp;

  @JsonProperty(value = "idle_since") protected String idleSince;

  @JsonProperty(value = "memory") protected long memory;

  @JsonProperty(value = "message_bytes") protected long messageBytes;

  @JsonProperty(value = "message_bytes_persistent") protected long messageBytesPersistent;

  @JsonProperty(value = "message_bytes_ram") protected long messageBytesRam;

  @JsonProperty(value = "message_bytes_ready") protected long messageBytesReady;

  @JsonProperty(value = "message_bytes_unacknowledged") protected long messageBytesUnacknowledged;
  ...
  @JsonProperty(value = "messages_persistent") protected int messagesPersistent;

  @JsonProperty(value = "messages_ram") protected long messagesRam;
  ...
  @JsonProperty(value = "messages_ready_ram") protected long messagesReadyRam;
  ...
  @JsonProperty(value = "messages_unacknowledged_ram") protected long messagesUnacknowledgedRam;

  @JsonProperty(value = "node") protected String node;

  @JsonProperty(value = "policy") protected Policy policy;

  @JsonProperty(value = "recoverable_slaves") protected Object recoverableSlaves;
