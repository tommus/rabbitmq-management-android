...
public class Channel {
  ...
  @JsonProperty(value = "acks_uncommitted") protected int acksUncommitted;

  @JsonProperty(value = "confirm") protected boolean confirm;

  @JsonProperty(value = "connection_details") protected ChannelDetails connectionDetails;

  @JsonProperty(value = "consumer_count") protected int consumerCount;

  @JsonProperty(value = "global_prefetch_count") protected int globalPrefetchCount;
  ...
  @JsonProperty(value = "messages_uncommitted") protected int messagesUncommitted;

  @JsonProperty(value = "messages_unconfirmed") protected int messagesUnconfirmed;
  ...
  @JsonProperty(value = "transactional") protected boolean transactional;
