...
public class SelectRangeContract {
  interface View {
    ...
    void updateVisibleRanges(String[] visibleRanges);

    void close();
  }

  interface Presenter {
    void loadVisibleRanges(Supplier<String[]> supplier);

    void onItemClicked(MessagesIndicator.VisibleRange visibleRange);
  }
}
